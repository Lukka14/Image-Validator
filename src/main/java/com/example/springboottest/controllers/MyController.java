...
public class MyController {
    ...
    public String index() {
        ...
        String filePath = "src/main/java/com/example/springboottest/api/csv/new3.csv";
        MimeMessage mimeMessage;
        try {
//            csvData.writeCSVFile(filePath);
            mimeMessage = GmailApi.createEmailWithAttachment("trendbatumi2@gmail.com", "me", "es aris testiii..", "vin iyo kata?!", csvData.getDataAsString());
